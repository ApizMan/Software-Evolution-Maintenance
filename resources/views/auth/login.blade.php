...
<x-guest-layout>
    <main id="main" class="main-site left-sidebar">
        <div class="container">
            ...
            <div class="container-img"><img src="/assets/images/login-background.png" alt="background image" srcset="">
            </div>
        </div>
                            ...
                            <div class="login-form form-item form-stl">
                                    ...
                                    {{-- <center><input class="check" type="checkbox" id="checkbox_toggle">
                                        <div class="checkbox">
                                            <label for="checkbox_toggle" class="slide">
                                                ...
                                                <label for="checkbox_toggle" class="text"><a href="/user/dashboard"
                                                        style="color: black;">Cashier</a>&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                <label for="checkbox_toggle" class="text"><a href="/hub"
                                                        style="color: black;">Admin</a>&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                            </label>
                                        </div>
                                    </center> --}}
                                ...
                                <div class="mt-4">
                                    <p>Don't have an account? <a href="{{ route('register') }}"
                                            class="underline text-sm text-gray-600 hover:text-gray-900">Register</a></p>
                                </div>
                                <center>
