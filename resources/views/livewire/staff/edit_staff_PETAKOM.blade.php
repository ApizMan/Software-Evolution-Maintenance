...
<div class="container">
    ...
    <div class="wrap-breadcrumb">
        <ul>
            <li class="item-link"><a href="{{ url('/staff') }}" class="link">Staff</a></li>
            <li class="item-link"><span>Edit Staff</span></li>
        </ul>
    </div>
    <div class="row">
            ...
            <div class=" main-content-area">
                <div class="wrap-login-item ">
                    <div class="register-form form-item ">
                        ...
                        <form class="form-stl" action="/staff/{{$users->id}}/update" name="frm-login" method="POST" >
                            @csrf
